...
contract.methods.totalSupply().call((err, result) => { console.log("Total Supply is" + result) });
contract.methods.balanceOf(contAdd).call((err, result) => { console.log("Balance of account is " + result) })